...
class Train extends ConsumerStatefulWidget {
  const Train({super.key});

  @override
  ConsumerState<Train> createState() => _TrainState();
}

class _TrainState extends ConsumerState<Train> {
